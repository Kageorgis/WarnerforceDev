...
($traceurRuntime.createClass)(ColumnSorting, {
  ...
  sort: function() {
     if (typeof this.hot.sortOrder == 'undefined') {
      ...
      for (var i = 0, ilen = nrOfRows; i < ilen; i++) {
        //console.log('test : ',i);
        var tempArray = [i, this.hot.getDataAtCell(i, this.hot.sortColumn + colOffset)];
        //console.log('tempArray : ',tempArray);
        this.hot.sortIndex.push(tempArray);
      }
      var tempSortIndex = this.hot.sortIndex;
      
      //console.log('before this.hot.sortIndex :::::::::: ',tempSortIndex);
      //console.log('test:::::',colMeta.sortFunction,colMeta.type);
      ...
      console.log('after this.hot.sortIndex :::::::::: ',this.hot.sortIndex);
      
      // Append spareRows
      for (var _i = this.hot.sortIndex.length; _i < this.hot.countRows(); _i++) {
        this.hot.sortIndex.push([_i, this.hot.getDataAtCell(_i, this.hot.sortColumn + colOffset)]);
      }

      this.hot.sortingEnabled = true; // this is required by translateRow plugin hook
      sortIndex = [];
      for (var _i = 0; _i < this.hot.sortIndex.length ; _i++) {
        //console.log('index-------------',this.hot.sortIndex[_i]);
        if(this.hot.sortIndex[_i]){
            var index = this.hot.sortIndex[_i][0];
            var tempArray = [index, this.hot.sortIndex[_i][1]];
            
            //console.log('index-------------',index);
            sortIndex.push(tempArray);
        }
      }
      //console.log('updated this.hot.sortIndex :::::::::: ',sortIndex);
  },
  translateRow: function(row) {
    if (this.hot.sortingEnabled && (typeof this.hot.sortOrder !== 'undefined') && this.hot.sortIndex && this.hot.sortIndex.length && this.hot.sortIndex[row]) {
      //console.log('this.hot.sortIndex[row][0] : ',row,'-----------',this.hot.sortIndex[row][0],'-----after index----',sortIndex[row][0]);
      if(this.hot.sortIndex[row][0]){
          return this.hot.sortIndex[row][0];
      }else{
          this.hot.sortIndex[row][0] = sortIndex[row][0];
          return sortIndex[row][0];
      }
